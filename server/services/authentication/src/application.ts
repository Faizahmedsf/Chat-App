...
import {AuthenticationComponent, STRATEGY} from 'loopback4-authentication';
import {
...
import { GoogleOauth2SignupProvider } from './providers/google-oauth2-signup.provider.ts';
